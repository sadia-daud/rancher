		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"isLogin": {
						SchemaProps: spec.SchemaProps{
							Description: "Indicates a login/session token. Non-session tokens are derived from some other token.",
							Default:     false,
							Type:        []string{"boolean"},
							Format:      "",
						},
				...
				Required: []string{"userID", "ttl", "isLogin"},
			},
		},
	}
}
...
func schema_pkg_apis_extcattleio_v1_TokenStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"expired": {
						SchemaProps: spec.SchemaProps{
							Description: "Expired flag, derived from creation time and time-to-live",
							Default:     false,
							Type:        []string{"boolean"},
							Format:      "",
						},
					...
					"expiredAt": {
						SchemaProps: spec.SchemaProps{
							Description: "ExpiresAt is creation time + time-to-live, i.e. when the token expires.  This is set to the empty string if the token does not expire at all.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"userPrincipal": {
						SchemaProps: spec.SchemaProps{
							Description: "UserPrincipal holds the detailed user data. Most of the fields can be given standard values or are not relevant. Display name and login name are retrieved from the User resource referenced by `Spec.UserID`. Provider is the `AuthProvider`. Meta.name is retrieved from the UserAttribute resource referenced by `Spec.UserID`.",
							Default:     map[string]interface{}{},
					...
					"lastUpdateTime": {
						SchemaProps: spec.SchemaProps{
							Description: "Time of last change to the token",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"lastUsedAt": {
						SchemaProps: spec.SchemaProps{
							Description: "LastUsedAt records the last time the token was used in a request, at second granularity.",
		...
		Dependencies: []string{
			"github.com/rancher/rancher/pkg/apis/management.cattle.io/v3.Principal", "k8s.io/apimachinery/pkg/apis/meta/v1.Time"},
	}
}
